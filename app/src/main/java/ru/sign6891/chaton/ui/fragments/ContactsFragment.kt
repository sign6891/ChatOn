...
class ContactsFragment : BaseFragment(R.layout.fragment_contacts) {
    ...
    private var mapListeners = hashMapOf<DatabaseReference, AppValueEventListener>()//для очистки памяти от созданных объектов(слушателей для Firebase)
        ...
        mAdapter = object : FirebaseRecyclerAdapter<CommonModel, ContactsHolder>(options) {
            ...
            override fun onBindViewHolder(holder: ContactsHolder, position: Int, model: CommonModel) {
                ...
                mRefUsersListener = AppValueEventListener {
                    //extensions function in appDatabaseHelper
    ...
    override fun onPause() {
        ...
        //очистка памяти от созданных объектов Адаптера, чтоб не было ликов
